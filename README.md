...
![wiring_diagram](images/image02.png)
...
| 성명 | 역할 | 담당 업무 |
| :--- | :--- | :--- |
| **조예은** | **전체 총괄** | 프로젝트 PM, 전체 일정 관리 및 기획 통합 |
| **전병철** | **하드웨어 팀장** | 다관절 로봇팔 메커니즘 설계 및 하드웨어 통합 |
| **박원빈** | **제어 팀장** | 임베디드 시스템 구축, 역기구학 및 모터 제어 알고리즘 구현 |
| **이상현** | **인공지능 팀장** | YOLOv8 기반 음식 인식 및 입 위치 추적(Mouth Tracking) 모델 개발 |
